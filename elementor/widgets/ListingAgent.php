...
class ListingAgent extends Widget_Base {
	...
	public function get_name() {
		return 'wpsight_geneva_listing_agent';
	}

	public function get_title() {
		return __( 'Listing Agent', 'wpcasa-geneva' );
	}
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            'display_image',
            [
                'label' => __( 'Display agent image', 'wpcasa-geneva' ),
        ...
        $this->add_control(
            'image_size',
            [
                'label' => __( 'Image Size:', 'wpcasa-geneva' ),
        ...
        $this->add_control(
            'display_company',
            [
                'label' => __( 'Display agent company', 'wpcasa-geneva' ),
                'type' => Controls_Manager::SWITCHER,
                'label_off' => __( 'False', 'wpcasa-geneva' ),
                'label_on' => __( 'True', 'wpcasa-geneva' ),
                'default' => 'yes',
        ...
        $this->add_control(
            'display_phone',
            [
                'label' => __( 'Display agent phone', 'wpcasa-geneva' ),
                'type' => Controls_Manager::SWITCHER,
                'label_off' => __( 'False', 'wpcasa-geneva' ),
                'label_on' => __( 'True', 'wpcasa-geneva' ),
                'default' => 'yes',
        ...
        $this->add_control(
            'display_social',
            [
                'label' => __( 'Display social profiles', 'wpcasa-geneva' ),
                'type' => Controls_Manager::SWITCHER,
                'label_off' => __( 'False', 'wpcasa-geneva' ),
                'label_on' => __( 'True', 'wpcasa-geneva' ),
                'default' => 'yes',
...
//            'display_archive',
//            [
//                'label' => __( 'Display agent archive link', 'wpcasa-geneva' ),
//                'type' => Controls_Manager::SWITCHER,
//                'label_off' => __( 'False', 'wpcasa-geneva' ),
//                'label_on' => __( 'True', 'wpcasa-geneva' ),
//                'default' => 'yes',
